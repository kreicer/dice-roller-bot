command_hello_text = f"Hello, friend!\n\n" \
             ...
             f"And be your useful helper on this way, of course. " \
             f"I recommend start from something simple... Make a <green>d20<end> dice roll!\n\n" \
             f"You can roll a simple dice, complex dice with multipliers and also with Postfixes! " \
             ...
             f"Next part - command name. In our case it will be <green>\"roll\"<end>. " \
             ...
             f"You can get list of postfixes with command <green>/postfix<end>."
